...
singularity run /shared/apps/bin/pytorch_rocm5.4_ubuntu20.04_py3.8_pytorch_1.12.1.sif python3 /var/lib/jenkins/pytorch-micro-benchmarking/micro_benchmarking_pytorch.py --network resnet50
